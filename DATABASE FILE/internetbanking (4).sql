...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2025 at 07:12 AM
...
INSERT INTO `loan_applications` (`id`, `applicant_name`, `loan_amount`, `application_date`, `status`, `reviewed_by`, `review_date`, `remarks`, `client_id`, `loan_type_id`, `is_approved_by_staff`, `income_salary`) VALUES
(4, 'John Doe', 7500.00, '2025-02-04 10:00:00', 'recommended', 3, '2025-02-04 14:17:20', 'dvd', 11, 2, 0, 0.00),
(7, 'Abc', 2345.00, '2025-02-04 12:58:32', 'recommended', 3, '2025-02-04 14:56:00', 'd', 11, 3, 0, 0.00),
(8, 'Darshan', 300000.00, '2025-02-04 12:59:46', 'rejected', 3, '2025-02-16 19:22:45', 'yoo', 11, 10, 0, 0.00),
(13, 'Jenil Dineshbhai dhola', 10000.00, '2025-02-16 18:36:01', 'recommended', 3, '2025-02-16 18:36:53', 'GOOD', 10, 3, 0, 0.00),
(14, 'utsav cheta', 100000.00, '2025-02-16 18:55:04', 'pending', NULL, NULL, 'HEYY', 10, 2, 0, 50000.00);
...
(2, 'Home_Loan', 'A Home Loan is a long-term financial product designed to help individuals buy property.', 8.25, 5000000.00, '2025-02-04 05:48:43'),
(3, 'Car_Loan', 'A Car Loan is used to finance the purchase of a vehicle, often with fixed interest rates.', 7.50, 30000.00, '2025-02-04 05:48:43'),
(4, 'Personal_Loan', 'A Personal Loan is an unsecured loan for personal expenses such as travel or medical needs.', 10.00, 20000.00, '2025-02-04 05:48:43'),
(5, 'Education_Loan', 'An Education Loan helps students finance their tuition and other academic expenses.', 5.75, 100000.00, '2025-02-04 05:48:43'),
(6, 'Business_Loan', 'A Business Loan provides funds to entrepreneurs and companies for business growth.', 9.00, 250000.00, '2025-02-04 05:48:43'),
(7, 'Gold_Loan', 'A Gold Loan is secured against gold jewelry and has a lower interest rate.', 6.50, 50000.00, '2025-02-04 05:48:43'),
(8, 'Credit_Card_Loan', 'A Credit Card Loan is an extension of credit card limits for financial flexibility.', 12.50, 15000.00, '2025-02-04 05:48:43'),
(9, 'Agriculture_Loan', 'An Agriculture Loan supports farmers in purchasing equipment, seeds, and livestock.', 4.50, 120000.00, '2025-02-04 05:48:43'),
(10, 'Mortgage_Loan', 'A Mortgage Loan allows individuals to borrow against the value of their property.', 7.80, 450000.00, '2025-02-04 05:48:43'),
(11, 'Two_Wheeler_Loan', 'A Two-Wheeler Loan is used to finance the purchase of motorcycles and scooters.', 8.00, 80000.00, '2025-02-04 05:48:43');
...
--
ALTER TABLE `ib_transactions`
  MODIFY `tr_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
