...
if (isset($_POST['deposit'])) {
    if(isset($_GET['account_id']) && isset($_GET['account_number']) && isset($_GET['client_id'])) {
        ...
        if ($transaction_amt <= 0) {
            ...
            if ($stmt->affected_rows && $notification_stmt->affected_rows) {
                $mysqli->commit();
                                ...
                                <form method="post" enctype="multipart/form-data" role="form">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col-md-6 form-group">
                                                <label for="exampleInputPassword1">Amount Transferred(Rs.)</label>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <?php if(isset($transaction_error)): ?>
                                            <p class="text-danger"><?php echo $transaction_error; ?></p>
                                        <?php endif; ?>
                                    </div>
                                </form>
                            </div>
