...
if (isset($_POST['verify_otp'])) {
    ...
    $query = "SELECT * FROM iB_clients WHERE email=? AND otp=? AND otp_expiry > NOW()";
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: client_reset_password.php");
        exit();
    } else {
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <p class="mt-2">
                    <a href="client_forget_password.php">Resend OTP</a>
                </p>
            </div>
        </div>
    </div>
