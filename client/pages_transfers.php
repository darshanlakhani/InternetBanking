                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="pages_transfers.php">iBank Finances</a></li><!-- Added .php extension here -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Select any account to transfer funds from</h3><!-- Removed 'on' from 'on any account' -->
                        </div>
                        <div class="card-body">
