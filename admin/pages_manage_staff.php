        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-<?php echo $row->is_active ? 'warning' : 'primary'; ?> btn-sm" 
                   href="pages_manage_staff.php?toggleStaff=<?php echo $row->staff_id; ?>&status=<?php echo $row->is_active; ?>">
                    <i class="fas fa-<?php echo $row->is_active ? 'times' : 'check'; ?>"></i> 
                    <?php echo $row->is_active ? 'Disable' : 'Enable'; ?>
                </a>
                <a class="btn btn-danger btn-sm" href="pages_manage_staff.php?deleteStaff=<?php echo $row->staff_id; ?>">
