...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-purple">
                                ...
                                <!-- form start -->
                                <form method="post" enctype="multipart/form-data" role="form" onsubmit="return validateForm()">
                                    <div class="card-body">
                                        <div class="row">
    ...
    <script>
        ...
        function validateForm() {
            ...
            var clientNumber = document.getElementById('exampleInputPassword1').value;
            var phone = document.getElementById('phone').value;
            var email = document.getElementById('email').value;
            var password = document.getElementById('exampleInputPassword1').value;
            var address = document.getElementById('address').value;

            if (name.trim() == '' || clientNumber.trim() == '' || phone.trim() == '' || email.trim() == '' || password.trim() == '' || address.trim() == '') {
