...
if (!isset($_SESSION['client_id'])) {
    ...
    echo "Client ID: " . $_SESSION['client_id']; // Debug output
}

$client_id = $_SESSION['client_id']; // Get logged-in user's client ID

// Revised query using the correct column name from loan_types table
$query = "SELECT la.id,
                 la.loan_type_id,
                                        ...
                                        <tbody>
                                            ...
                                            if ($result && $result->num_rows > 0) {
                                                while ($row = $result->fetch_object()) {
                                                    echo "<tr>";
                                                    echo "<td>" . $count . "</td>";
                                                    // Display the loan type using the alias "loan_type"
                                                ...
                                                echo "<tr><td colspan='6' class='text-center'>No loan applications found.</td></tr>";
                                            }
                                            ?>
                                        </tbody>
                                    </table>
