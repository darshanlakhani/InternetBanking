...
if (isset($_POST['deposit'])) {
    ...
    if ($transaction_amt <= 0) {
        $transaction_error = "Invalid transaction amount. Please enter a positive amount.";
    } else {
        // Check if the transaction amount is greater than the available balance
