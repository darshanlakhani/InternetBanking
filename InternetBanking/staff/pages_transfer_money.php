...
if (isset($_POST['deposit'])) {
    ...
    if ($transaction_amt <= 0) {
        $err = "Invalid transfer amount. Please enter a valid amount.";
    } else {
        ...
        /*
        * You can't transfer money from a bank account that has no money in it so
        ...
        */
        ...
        if ($transaction_amt > $amt) {
            ...
            // Bind parameters
            $rc = $stmt->bind_param('ssssssssssssss', $tr_code, $account_id, $acc_name, $account_number, $acc_type, $tr_type, $tr_status, $client_id, $client_name, $transaction_amt, $client_phone, $receiving_acc_no, $receiving_acc_name, $receiving_acc_holder);
