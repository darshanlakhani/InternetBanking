...
if (isset($_POST['login'])) {
  ...
  if ($rs) { //if it's successful
    $_SESSION['success_msg'] = "Login Successful"; // set success message
    header("location:pages_dashboard.php");
    exit; // After redirecting, make sure to exit to prevent further execution
  } else {
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        if (isset($_SESSION['success_msg'])) {
          ...
          unset($_SESSION['success_msg']); // unset session variable after displaying the message
        }
        ?>
